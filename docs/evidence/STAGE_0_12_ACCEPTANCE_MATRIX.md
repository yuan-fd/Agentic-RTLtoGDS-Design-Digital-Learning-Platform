...
| 1–3 Labs、三入口、教学骨架 | 已证实 | 真实 Firefox 页面渲染、认证 API 回放、教学 API 回归 |
...
| 7 Dashboard、Agent 状态、证据投影 | 已证实（API/页面渲染） | Dashboard 测试；Runtime artifact projection；Firefox 页面 smoke |
...
| 并发能力 | 8 用户 smoke 已证实 | `run_teaching_http_concurrency_smoke.py`：8/8；并发证据文档 |
