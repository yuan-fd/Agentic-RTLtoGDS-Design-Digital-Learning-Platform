...
class CodexCliSpecProvider:
    ...
    def propose(self, messages: Sequence[Mapping[str, str]], current: Mapping[str, Any],
        ...
        prompt = (
            ...
            "If the latest user turn explicitly asks for conservative automatic resolution, turn "
            "omitted platform choices into documented defaults and turn unassigned finite input "
            "encodings into explicit reserved zero/no-op behavior. In that mode, do not keep those "
            "resolved choices in missing_fields or clarification_questions; never invent ports or "
