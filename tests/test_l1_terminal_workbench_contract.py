...
def test_terminal_harness_exposes_guided_runtime_facts_not_local_state() -> None:
    ...
    for label in ("1 GOAL / IR", "2 TOOL / POLICY", "3 STATE / EVIDENCE",
                  ...
                  ":baseline", ":m1-propose", ":candidate <proposal-id>",
                  ":compare <baseline-run-id>", ":query <timing|congestion|drc|power|metrics>",
    ...
    assert "setup_wns_ns" in source and "area_um2" in source and "drc_errors" in source
